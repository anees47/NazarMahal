...
<body>
    <div class='container'>
        <div class='content'>
            ...
            <a href='{manageOrdersUrl}' class='button'>Manage Orders</a>
        </div>
    </div>
</body>
</html>";
...
<body>
    <div class='container'>
        <div class='header'>
            ...
            <p style='margin: 10px 0 0 0; font-size: 16px;'>Your appointment request has been received</p>
        </div>
        <div class='content'>
            <p>Dear <strong>{userName}</strong>,</p>
            <p>Thank you for scheduling an appointment with <strong>Nazar Mahal</strong>. We have received your request!</p>
            ...
            <div style='background: #fff3cd; padding: 15px; border-left: 4px solid #ffc107; margin: 20px 0; border-radius: 4px;'>
                ...
                <p style='margin: 10px 0 0 0;'>Once your appointment is confirmed by the Nazar Mahal team, you will receive a separate confirmation email.</p>
            </div>

            <div style='background: #e8f4f8; padding: 15px; border-left: 4px solid #667eea; margin: 20px 0; border-radius: 4px;'>
                <strong>📞 Contact Us:</strong>
                <p style='margin: 10px 0 0 0;'>If you need to contact us for any reason, please call <strong>+92-300-1239199</strong> or email <a href='mailto:support@nazarmahal.com' style='color: #667eea; text-decoration: none;'>support@nazarmahal.com</a></p>
            </div>
        ...
        <div class='footer'>
            ...
            <p>Email: support@nazarmahal.com | Phone:  +92-300-1239199</p>
...
<body>
    <div class='container'>
        <div class='header'>
            ...
            <p style='margin: 10px 0 0 0; font-size: 16px;'>Your appointment has been confirmed by our team</p>
        </div>
        <div class='content'>
            <p>Dear <strong>{userName}</strong>,</p>
            <p>Great news! Your appointment with <strong>Nazar Mahal</strong> has been <strong style='color: #28a745;'>CONFIRMED</strong>. We're looking forward to seeing you!</p>

            <div class='appointment-details'>
                <h3 style='margin-top: 0; color: #28a745;'>Confirmed Appointment Details</h3>
                <div class='detail-row'>
                    <span class='detail-label'>Appointment Type:</span>
            ...
            <div style='background: #e8f4f8; padding: 15px; border-left: 4px solid #17a2b8; margin: 20px 0; border-radius: 4px;'>
                <strong>📞 Contact Us:</strong>
                <p style='margin: 10px 0 0 0;'>If you have any questions, please call <strong>+92-300-1239199</strong> or email <a href='mailto:support@nazarmahal.com' style='color: #667eea; text-decoration: none;'>support@nazarmahal.com</a></p>
            </div>
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <div style='background: #fff3cd; padding: 15px; border-left: 4px solid #ffc107; margin: 20px 0; border-radius: 4px;'>
                <strong>⚠️ Important:</strong>
                <p style='margin: 10px 0 0 0;'>If you did not make this change, please contact us immediately at <strong>support@nazarmahal.com</strong>.</p>
            </div>
