...
namespace NazarMahal.Application.RequestDto.AppointmentRequestDto
{
    ...
    {
        /// <summary>
        /// User ID - optional, populated if user is authenticated
        /// </summary>
        public int? UserId { get; set; }

        /// <summary>
        /// Full name - optional if user is authenticated, required for anonymous
        /// </summary>
        public string? FullName { get; set; }

        /// <summary>
        /// Email - optional if user is authenticated, required for anonymous
        /// </summary>
